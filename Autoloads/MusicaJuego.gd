...
onready var lista_musicas:Dictionary ={"menu_principal": $MusicaMenu}setget ,get_lista_musicas
...
func _on_TweenMusicaOff_tween_completed(object:Object, _key:NodePath):
	object.stop()
